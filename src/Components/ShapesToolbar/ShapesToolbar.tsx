        ...
        <div className="shape-toolbar-container 3">
            <a className={`shape-selection ${triangleHighlight}`}
               onClick= { () => props.selectionHandler(SelectedShape.Triangle)}>
                {/* <a onClick= { () => props.selectionHandler(SelectedShape.Triangle)}> */}
                {/* </a> */}
            ...
            <div className={`shape-selection ${rectangleHighlight}`}
                 >
                <a className = "fill-div" onClick = { () => props.selectionHandler(SelectedShape.Rectangle) }> </a>
            ...
            <div className={`shape-selection ${circleHighlight}`}
                 >
                <a className="fill-div" onClick = { () => props.selectionHandler(SelectedShape.Circle) }>
                <svg className="shape-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 147 147">
